...
function doublewager() {
  ...
  console.log(playingbalance.innerHTML);
  let newStr = playingbalance.innerHTML.substring(1); // "removes the $ from the playing balance"
  console.log(newStr);

  if (parseInt(currentwager.innerHTML) * 2 <= parseInt(newStr)) {
    console.log('doubled!')
    currentwager.innerHTML = parseInt(currentwager.innerHTML) * 2;
    playingwager.innerHTML = "Wager: $" + currentwager.innerHTML;
  } else {
    alert('Sorry, you do not have enough to double your wager')
  }
